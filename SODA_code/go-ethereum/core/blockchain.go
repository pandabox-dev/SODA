...
func (bc *BlockChain) insertChain(chain types.Blocks, verifySeals bool) (int, []interface{}, []*types.Log, error) {
	...
	for ; block != nil && err == nil || err == ErrKnownBlock; block, err = it.next() {
		...
		// t_start := time.Now().UnixNano() / 1e6
		// //add new 
		receipts, logs, usedGas, err := bc.processor.Process(block, statedb, bc.vmConfig)
		// //add new 
		// t_end := time.Now().UnixNano() / 1e6
		// tingrong.BLOCK_TIME_LIST[tingrong.COUNT_ARRAY][0] = strconv.FormatInt(blocknumber, 10)
		// tingrong.BLOCK_TIME_LIST[tingrong.COUNT_ARRAY][1] = strconv.FormatInt(t_start, 10)
		// tingrong.BLOCK_TIME_LIST[tingrong.COUNT_ARRAY][2] = strconv.FormatInt(t_end, 10)
		// tingrong.COUNT_ARRAY += 1
		// if tingrong.COUNT_ARRAY%100000 == 0 {
		// 	write_path := "blocktime/block_time_framework_fallback"
		// 	fd, err := os.OpenFile(write_path, os.O_RDWR|os.O_CREATE|os.O_APPEND, 0644)
		// 	if err != nil {
		// 		fmt.Println("Failed to open the file", err.Error())
		// 	}
		// 	for i := 0; i < 100000; i++ {
		// 		_, err1 := io.WriteString(fd, tingrong.BLOCK_TIME_LIST[i][0]+"#"+tingrong.BLOCK_TIME_LIST[i][1]+"#"+tingrong.BLOCK_TIME_LIST[i][2]+"\n")
		// 		if err1 != nil {
		// 			fmt.Println("Failed to write the info:", err1.Error())
		// 		}
		// 	}
		// 	fd.Close()
		// 	// defer fd.Close()
		// 	tingrong.COUNT_ARRAY = 0
		// 	// block_time_list = make([100000][3]string, 0)
		// 	tingrong.BLOCK_TIME_LIST = tingrong.CLEAR_BLOCK_TIME_LIST
		// }
		// //add new 
