...
//add new —— single plugin
func (api *PublicEthereumAPI) RegisterPlg(plgName string) string {
	path := "./plugin/" + plgName + ".so"
	fei.IsReg = true
	fei.RegPath = path
	return "RegisterStart"
}

func (api *PublicEthereumAPI) UnregisterPlg(plgName string) string {
	fei.UnPlg = plgName
	fei.IsUn = true
